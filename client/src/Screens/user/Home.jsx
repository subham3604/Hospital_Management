...
const Home = () => {
  return (
    <>
      <div
        id="home"
        className="w-full mb-[80px] h-[600px] flex items-center justify-center"
      >
        <div className="h-[80%] w-[80%] border flex bg-white rounded-2xl shadow-2xl">
          <div className="w-1/2 h-full transform transition duration-500 hover:scale-110 flex flex-col justify-center items-center flex-wrap">
            ...
            <div className="mt-4">
              ...
              <div className="flex text-2xl">
                ...
                <div>
                  ...
                  <p className="text-[20px] text-gray-400">2019MCB1222</p>
                </div>
              </div>
            </div>
          </div>
